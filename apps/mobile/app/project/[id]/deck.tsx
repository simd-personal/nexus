...
export default function ProjectDeckScreen() {
    ...
    <Screen edges={['left', 'right', 'bottom']}>
      <ScrollView contentContainerStyle={styles.content}>
        <ProjectGeneratePanel
          ...
          description={`Generate a slide-ready deck outline from ${projectName}. Sunny uses your uploaded materials and timeline.`}
        />
      </ScrollView>
    </Screen>
  );
