...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    title: 'Updating a file you already uploaded',
    body: 'Already uploaded a file but have a newer version? Open the menu on that file, choose Replace file, and upload the update. Sunny compares versions. Open the file and check the Changes tab.',
