...
export const metadata = createMarketingMetadata({
  title: 'Integrations',
  description:
    'Connect UpperDeck to Gmail, Outlook, Slack, Google Drive, Teams, Zoom, Notion, HubSpot, Salesforce, and more — sync client context into one command center.',
  path: '/integrations',
  keywords: [
...
export default function IntegrationsPage() {
  return (
    <MarketingPageLayout
      ...
      description="UpperDeck starts with flexible file upload today. Connectors bring email, chat, storage, meetings, and CRM data into each client project automatically."
    >
