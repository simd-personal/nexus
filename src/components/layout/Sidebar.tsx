...
export function Sidebar({ mobileOpen = false, onMobileClose }: SidebarProps) {
  ...
  return (
    <aside
      className={cn(
        'fixed left-0 top-0 z-50 flex h-screen w-64 flex-col border-r border-[var(--ud-cloud)] bg-white transition-transform duration-200 ease-in-out',
    ...
    >
      <div className="relative border-b border-[var(--ud-mist)] p-6">
        <button
          ...
          className="absolute right-4 top-4 flex h-8 w-8 items-center justify-center rounded-lg text-gray-500 hover:bg-gray-100 lg:hidden"
      ...
      <div className="border-t border-gray-100 p-4">
        <div className="mb-2 flex items-center gap-3 px-3 py-2">
          ...
          <div className="min-w-0">
            <p className="truncate text-sm font-medium text-gray-900">{AI_EMPLOYEE_NAME}</p>
